init -100 python:
    ...
    minigame_enemy_behaviour_reaction = {
        0: "Этот выглядит достаточно сильным. Надо быть осторожным.",
        1: "Ну и ну, мой взгляд еле поспевает за ним. Надеюсь, я...",
        2: "Я не могу предугадать его действия!",
        3: "Видимо он не намерен драться. Достаточно поймать его и дело за мной.",
