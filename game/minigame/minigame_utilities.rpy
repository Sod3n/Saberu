init -100 python:
    ...
    minigame_enemy_behaviour_reaction = {
        0: "Этот чёрт выглядит достаточно сильным. Надо быть осторожным.",
        1: "Ну и ну, мой взгляд еле поспевает за ним. Надеюсь, я поспею за ним.",
        2: "Я не могу предугадать его действия!",
        3: "Видимо он не намерен драться. Достаточно поймать его и дело в шляпе.",
        4: "Сейчас я тоже попадусь в мышеловку, и горе тем кошкам, которые посмеют тронуть такую мышь!",
        5: "Доколе он свят, но всё ещё ёкай.",
        6: "Его искусство владения луком превосходит мой ажидания. Надо сближаться по возможности.",
        7: "Вероятно я спутал мононоке с крапивой? Но мне всё ещё надо срубить её, чтобы пройти дальше.",
    }
